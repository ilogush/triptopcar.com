...
const CarCard: React.FC<CarCardProps> = ({ className, car }) => {
  return (
    <article className={clsx("bg-white p-5 rounded-lg", className)}>
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="col-span-1 md:col-span-1">
          <div className="">
            <Image src={car.imageUrl} alt={`${car.name} Image`} width={400} height={400} />
          </div>
        </div>
        <div className="col-span-1 md:col-span-1 p-6">
          <header className="grid grid-cols-2 max-md:mx-auto gap-3 pb-6">
          ...
          <main className="flex items-start w-full gap-12 max-md:flex-col">
